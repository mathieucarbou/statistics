...
public class GraphUtils {
  ...
  public static void writeGraph(File output,
                                List<LongSample> samples, Map<String, Percentile> percentiles, DomainOrder domainOrder,
  ...
  public static void writeGraph(File output,
                                List<Histogram.Bucket> buckets, Map<String, Percentile> percentiles, DomainOrder domainOrder,
  ...
  private static void addMarkers(Map<String, Percentile> percentiles, XYPlot plot) {
    for (Map.Entry<String, Percentile> entry : percentiles.entrySet()) {
  ...
  private static String stringify(Map<String, Percentile> percentiles) {
